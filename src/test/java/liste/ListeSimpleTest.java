...
class ListeSimpleTest {
   ...
   @Test void echangerMemeNoeud_NoOp() {
        // Liste : 1,2,3,4,5
        listeATester.ajout(5);
        listeATester.ajout(4);
        listeATester.ajout(3);
    ...
    @Test
    void supprimePremier_ElementAbsent_NeChangeRien() {
        // Liste : 1,2,3
        listeATester.ajout(3);
        listeATester.ajout(2);
        listeATester.ajout(1);
    ...
    @Test
    void modifiePremier_ElementAbsent_NeChangeRien() {
        // Liste : 1,2,3
        listeATester.ajout(3);
        listeATester.ajout(2);
        listeATester.ajout(1);
    ...
    @Test
    void supprimeTous_AucunMatch_NeChangeRien() {
        // Liste : 1,2,1
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.ajout(1);
